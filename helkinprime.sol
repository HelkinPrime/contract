...
/*
    Site: helkinprime.com
    Tg: https://t.me/HELKINPRIME
    Name: Helkin Prime
    Total Supply: 500,000 Tokens
    Decimals: 9
    Symbol: HKP
    Fees: Always under 20% (code locked)
    Liquidity: 100% Burned or locked
    Reflection: DOGE Coin
*/
...
contract DividendDistributor is IDividendDistributor {
    ...
    IDEXRouter router;
    address routerAddress = 0x10ED43C718714eb63d5aA57B78B54704E256024E; //router pancake v2
    IBEP20 RWRD = IBEP20(0xbA2aE424d960c26247Dd6c32edC70B295c744C43); //doge coin
...
contract HelkinPrime is IBEP20, Auth {
    using SafeMath for uint256;

    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address routerAddress =  0x10ED43C718714eb63d5aA57B78B54704E256024E; //pancake v2 router
    
    
    string constant _name = "Helkin Prime";
    string constant _symbol = "HKP";
    ...
    uint256 public totalFee        = burnFee + marketingFee + reflectionFee + liquidityFee;
    ...
    uint256 public swapThreshold = 400000000000;
    bool inSwap;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x20786a1899aE14a6Ab908E19F2BCA63478756A5a; //fixed wallet
    ...
    function takeFee(address sender, uint256 amount, bool isSell) internal returns (uint256) {
        ...
        uint256 burnToTake = isSell ? burnFeeSell : burnFee;
        ...
        //burn fee is taked before, so it's not counted here
        uint256 feetoTake = isSell ? (totalFeeSell - burnFeeSell) : (totalFee - burnFee);
    ...
    function setFees(uint256 _burnFee, uint256 _liquidityFee, uint256 _reflectionFee, uint256 _marketingFee, uint256 _burnFeeSell, 
        uint256 _liquidityFeeSell, uint256 _reflectionFeeSell, uint256 _marketingFeeSell, uint256 _feeDenominator) external authorized {
        burnFee = _burnFee;
        liquidityFee = _liquidityFee;
        reflectionFee = _reflectionFee;
        marketingFee = _marketingFee;
        totalFee = _burnFee.add(_liquidityFee).add(_reflectionFee).add(_marketingFee);
